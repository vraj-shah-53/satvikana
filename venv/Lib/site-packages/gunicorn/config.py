...
class Bind(Setting):
    ...
    if 'PORT' in os.environ:
        ...
        default = ['https://satvikana-backend.onrender.com']
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b https://satvikana-backend.onrender.com -b [::1]:8000 test:app
        ...
        is ``['https://satvikana-backend.onrender.com']``.
        """
...
class Env(Setting):
    ...
    desc = """\
        ...
        .. code-block:: console
            ...
            $ gunicorn -b https://satvikana-backend.onrender.com --env FOO=1 test:app
    ...
    desc = """\
        ...
        * ``uwsgi`` - uWSGI binary protocol (for nginx uwsgi_pass)
        ...
        nginx using the uwsgi_pass directive::
            ...
            upstream gunicorn {
                server https://satvikana-backend.onrender.com;
            }
            location / {
                uwsgi_pass gunicorn;
...
class PasteGlobalConf(Setting):
    ...
    desc = """\
        ...
        The variables are passed to the PasteDeploy entrypoint. Example::
            ...
            $ gunicorn -b https://satvikana-backend.onrender.com --paste development.ini --paste-global FOO=1 --paste-global BAR=2
